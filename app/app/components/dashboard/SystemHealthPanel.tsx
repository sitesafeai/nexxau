...
export default function SystemHealthPanel({ cameras, aiPerformance, loading }: SystemHealthPanelProps) {
        ...
        <div className="p-4 border-t border-slate-700/50 bg-slate-800/20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-slate-700/30 rounded-lg p-3 text-center">
              <p className="text-2xl font-bold text-emerald-400">{aiPerformance.accuracy}%</p>
              <p className="text-xs text-slate-400">Accuracy</p>
            </div>
            <div className="bg-slate-700/30 rounded-lg p-3 text-center">
              <p className="text-2xl font-bold text-amber-400">{aiPerformance.falsePositives}</p>
              <p className="text-xs text-slate-400">False Positives</p>
            </div>
            <div className="bg-slate-700/30 rounded-lg p-3 text-center">
              <p className="text-2xl font-bold text-red-400">{aiPerformance.falseNegatives}</p>
              <p className="text-xs text-slate-400">False Negatives</p>
            </div>
            <div className="bg-slate-700/30 rounded-lg p-3 text-center">
              <p className="text-2xl font-bold text-blue-400">{aiPerformance.totalDetections.toLocaleString()}</p>
