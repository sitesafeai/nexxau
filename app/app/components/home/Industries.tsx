        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            ...
            {industries.slice(0, 3).map((industry) => (
              <div 
                key={industry.name} 
                className="flex flex-col bg-gray-700 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-600"
              >
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300">
                  ...
                  <div className="mt-6">
                    <h4 className="text-sm font-semibold text-white mb-2">Key Segments</h4>
            ...
            <div className="lg:col-span-3 flex justify-center gap-8">
              {industries.slice(3).map((industry) => (
                <div 
                  key={industry.name} 
                  className="flex flex-col bg-gray-700 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300 w-full max-w-md border border-gray-600"
                >
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-white">
                    <div className={`${industry.color} p-2 rounded-lg`}>
                      <industry.icon className="h-6 w-6 text-white" aria-hidden="true" />
