      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400">System errors and debugging information</p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300 mb-4">
                This page is being rebuilt. The error logs dashboard will display:
              </p>
              ...
              <div className="bg-blue-900/20 border border-blue-700/50 rounded-lg p-4 mb-6">
                <p className="text-blue-300 text-sm">
                  <strong>💡 For now:</strong> System logs are available via the structured logging system. 
                  Check your server console or use <code className="bg-slate-800 px-2 py-1 rounded">GET /api/health</code> for system status.
                </p>
              </div>
