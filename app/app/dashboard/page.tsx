      ...
      <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/30 p-6 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <button 
            ...
            className="group relative bg-purple-600 hover:bg-purple-700 text-white p-6 rounded-lg border border-purple-500 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800"
          >
            <div className="flex items-center space-x-4">
              <div className="flex-shrink-0">
              ...
              <div className="text-left">
                ...
                <div className="text-purple-100 text-sm">Camera settings & controls</div>
              </div>
            </div>
          </button>
        </div>
