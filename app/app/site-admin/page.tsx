...
const InfoTooltip: React.FC<{ text: string }> = ({ text }) => {
  ...
  return (
    <div className="relative inline-block">
      ...
      {show && (
        <div className="absolute z-50 w-64 p-3 bg-gray-900 border border-gray-700 rounded-lg shadow-xl text-xs text-gray-300 left-0 bottom-6 mb-1">
          {text}
          <div className="absolute left-4 -bottom-1 w-2 h-2 bg-gray-900 border-r border-b border-gray-700 transform rotate-45"></div>
        </div>
      )}
    </div>
  );
