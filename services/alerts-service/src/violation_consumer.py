...
Consumes violation state changes from Redis Streams for alerting.
"""
import json
import logging
...
class ViolationStateChange:
    ...
    def should_send_alert(self) -> bool:
        ...
        Rules:
        - Only alert on ACTIVE and ESCALATED states
        - Must have should_alert flag set to true
...
class ViolationStateChangeConsumer:
    ...
    def __init__(
        ...
        consumer_group: str = "alerts-service",
